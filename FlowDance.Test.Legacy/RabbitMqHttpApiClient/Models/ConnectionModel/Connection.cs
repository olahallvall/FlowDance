...
namespace FlowDance.Test.Legacy.RabbitMqHttpApiClient.Models.ConnectionModel
{
    public class Connection
    {
        [System.Text.Json.Serialization.JsonConverter(typeof(EpochDateTimeConverter))]
