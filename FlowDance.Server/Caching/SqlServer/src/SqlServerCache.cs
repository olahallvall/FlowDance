...
/// </summary>
public class SqlServerCache : IDistributedCacheFlowDance
{
...
#pragma warning restore CA2208 // Instantiate argument exceptions correctly
    ...
    public bool SetOnce(string key, byte[] value, DistributedCacheEntryOptions options)
    {
        bool inserted;
        ...
        inserted = _dbOperations.SetCacheItemOnce(key, value, options);
